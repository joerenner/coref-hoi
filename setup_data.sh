...
#python preprocess.py --tokenizer bert-base-uncased --input_dir $data_dir --output_dir . --seg_len 128
#python preprocess.py --tokenizer bert-base-uncased --input_dir $data_dir --output_dir . --seg_len 384
python preprocess.py --tokenizer bert-base-uncased --input_dir $data_dir --output_dir . --seg_len 512
